...
namespace ShopApp.WebApi.Migrations
{
    ...
    [Migration("20250607053421_OrdersAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShopApp.Core.Models.Shop.Order.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ShopApp.Core.Models.Shop.Order.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ShopApp.Core.Models.User.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ShopApp.Core.Models.Shop.Order.OrderItem", b =>
                {
                    b.HasOne("ShopApp.Core.Models.Shop.Order.Order", "Order")
                        .WithMany("Items")
